 ...
 *
 * NOTE:
 * - Add french accented letter (already usable with compose key, another idea? SEND_STRING?)
*/
...
#define HARDER MO(_HARDER)
#define TBLENDR TG(_BLENDER)
#define LBLENDR MO(_LBLENDR)
#define TGAMING TG(_GAMING)
#define LGAMING MO(_LGAMING)
#define LSGAMNG MO(_LSGAMNG)
#define TEST MO(_TEST)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                               KC_LALT, KC_LGUI, TL_LOWR, KC_SPC,  KC_ENT,  TL_UPPR, KC_BSPC, KC_RALT
     ...
     */
[_LOWER] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   TGAMING, _______, _______, _______, _______, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     ...
     */
  [_LBLENDR] = LAYOUT(
  TBLENDR, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, KC_VOLU,
  _______, KC_P,    KC_O,    KC_I,    KC_U,    KC_Y,                      _______, _______, _______, _______, _______, KC_VOLD,
  KC_ESC,  KC_SCLN, KC_L,    KC_K,    KC_J,    KC_H,                      _______, _______, _______, _______, _______, _______,
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     ...
     */
  [_LGAMING] = LAYOUT(
  TGAMING, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      _______, _______, KC_MPLY, KC_MPRV, KC_MNXT, KC_VOLU,
  _______, KC_P,    _______, KC_I,    KC_U,    KC_Y,                      _______, _______, _______, _______, _______, KC_VOLD,
  KC_ESC,  _______, _______, _______, KC_J,    KC_H,                      _______, _______, _______, _______, _______, _______,
  LSGAMNG, KC_SLSH, KC_DOT,  KC_COMM, KC_M,    KC_N,    _______, _______, _______, _______, _______, _______, _______, LSGAMNG,
...
oled_rotation_t oled_init_user(oled_rotation_t rotation) {
  if (is_keyboard_master()) {
        return OLED_ROTATION_270;  // flip the master display (top to bottom)
    } else {
        return rotation;
    }
}
...
void render_default_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _ADJUST:
            ...
            break;
        case _HARDER:
            oled_write_P(PSTR("HARDR"), false);
            break;
        case _BLENDER:
            oled_write_P(PSTR("BLNDR"), false);
            break;
        case _LBLENDR:
            oled_write_P(PSTR("LBLDR"), false);
            break;
        case _GAMING:
